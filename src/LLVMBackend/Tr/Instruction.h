...
namespace LLVMB { namespace Tr
{
    ...
    ///
    /// An object of this class adds itself automatically to the Scope on constructor and removes itself from
    /// Scope in destructor. Therefore these are intended to be used as scoped objects actions
    ///
    /// This object contains the list of temporary destruct actions that need to be executed (in reverse order) when the
