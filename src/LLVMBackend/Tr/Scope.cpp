...
TrContext& Scope::context() const { return context_; }

const vector<Instruction*>& Scope::instructionsStack() const { return instructionsStack_; }

vector<Instruction*>& Scope::instructionsStack() { return instructionsStack_; }
