...
namespace Nest
{
    ...
    public:
        ...
        virtual void enter(const string& name, DynNode* node) = 0;
        ...
        virtual DynNodeVector allEntries() const = 0;
        ...
        virtual DynNodeVector lookupCurrent(const string& name) const = 0;
        ...
        /// Note that more than one symbols can be registered in the table with the same name
        virtual DynNodeVector lookup(const string& name) const = 0;
