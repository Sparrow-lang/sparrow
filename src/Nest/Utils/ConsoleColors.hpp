...
struct State {
    State(unsigned short code)
        : code_(code) {}
    unsigned short code_;
};
struct FgColor {
    FgColor(unsigned short color)
        : color_(color) {}
    unsigned short color_;
};
struct BgColor {
    BgColor(unsigned short color)
        : color_(color) {}
    unsigned short color_;
};

bool isDisabled() { return Nest_compilerSettings()->noColors_; }
...
static const FgColor fgHiWhite(
...
static const BgColor bgHiWhite(
...
public:
    con_dev() { hCon = GetStdHandle(STD_OUTPUT_HANDLE); }
...
#else
inline ostream& clr(ostream& os) { return os; };

inline ostream& operator<<(ostream& os, State s) { return os; }

inline ostream& operator<<(ostream& os, FgColor c) { return os; }

inline ostream& operator<<(ostream& os, BgColor c) { return os; }
#endif
} // namespace ConsoleColors
