...
struct Tuple2
{
    ...
    Tuple2(T1 p1, T2 p2) : _1(p1), _2(p2) {}

    bool operator <(const Tuple2& other) const
    {
        return (_1 < other._1)
            || (!(other._1 < _1) && (_2 < other._2));
    }
};
...
struct Tuple3
{
    ...
    Tuple3(T1 p1, T2 p2, T3 p3) : _1(p1), _2(p2), _3(p3) {}
...
namespace std
{
    ...
    template <typename T1, typename T2, typename T3, typename T4>
    struct hash<Tuple4<T1, T2, T3, T4> >
    {
        size_t operator()(const Tuple4<T1, T2, T3, T4>& t) const
        {
            return hash<T1>()(t._1) + 393241 * hash<T2>()(t._2) + 786433 * hash<T3>()(t._3) + 1572869 * hash<T4>()(t._4);
        }
    };
}
