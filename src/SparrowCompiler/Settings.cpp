...
bool initSettingsWithArgs(int argc, char** argv) {
    ...
    OptionEntry optionsMap[] = {
            ...
            {"-fsyntax-only", NULL, s.syntaxOnly_,
                    "check only the syntax, including type checking"},
            {"-c", NULL, s.compileAndAssembleOnly_,
