...
namespace SprFrontend
{
    ...
    Nest::TypeRef getType(Nest::Node* typeNode);
    ...
    Nest::Node* createTypeNode(CompilationContext* context, const Nest::Location& loc, Nest::TypeRef t);
    
    
    /// Gets the type to be used when auto is found for a node; removes l-values, but tries to preserve references
    Nest::TypeRef getAutoType(Nest::Node* typeNode, bool addRef = false);
